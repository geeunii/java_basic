...
public class CartItem {
    ...
    public String[] getItemBook() { // getItemBook 의 멤버 변수 값을 가져오는 역할
        return itemBook;
    }

    public void setItemBook(String[] itemBook) {    // 매개변수로 받은 새로운 String[] 배열 값을 this.itemBook 멤버 변수에 할당(설정하는) 역할
