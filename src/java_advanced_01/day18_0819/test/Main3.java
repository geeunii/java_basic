package java_advanced_01.day18_0819.test;
...
public class Main3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-------나이순 순 오름차순후 같은 나이면 이름순으로 정렬-----------");
        Arrays.sort(users, Comparator.comparing(User::getAge).thenComparing(User::getName)); // thenComparing 으로 비교
        for (User user : users) {
            System.out.println(user.getName() + " " + user.getAge() + "세");
        }
    }
